...
public class NoEmptyFieldsOnPageRule extends BaseRule {

    public static final String MESSAGE_KEY = "validation.message.noemptyfieldsonpage";
    ...
    public RuleType getType() {
        return RuleType.CUSTOM_PAGE_VALIDATION_RULE;
    }

    @Override
    public ErrorMessage getMessage(String name, String label, String value) {
        return new ErrorMessage(MESSAGE_KEY, name, label, "Page " + label + " contains empty fields");
    }
