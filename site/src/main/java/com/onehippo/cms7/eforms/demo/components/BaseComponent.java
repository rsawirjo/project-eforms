...
import com.onehippo.cms7.eforms.demo.componentsinfo.GeneralListInfo;
import com.onehippo.cms7.eforms.demo.componentsinfo.PageableListInfo;
...
public abstract class BaseComponent extends BaseHstComponent {
    ...
    protected void createAndExecuteSearch(final HstRequest request, final GeneralListInfo info, final HippoBean scope, final String query) throws HstComponentException {
        ...
        Class filterClass = request.getRequestContext().getContentBeansTool()
                .getObjectConverter().getClassFor(docType);
        if(filterClass == null) {
        ...
        try {
            ...
            HstQuery hstQuery = request.getRequestContext().getQueryManager().createQuery(scope, filterClass, true);
